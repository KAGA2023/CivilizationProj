...
void UMainHUD::NativeConstruct()
{
	...
	// ResearchBtn 클릭 이벤트 바인딩 (OpenResearchUI 애니메이션 재생)
	if (ResearchBtn)
	{
		ResearchBtn->OnClicked.AddDynamic(this, &UMainHUD::OnResearchButtonClicked);
	}
...
void UMainHUD::ShowAIDefeatWidget(int32 DefeatedPlayerIndex)
{
	...
	if (AIPlayerLoseUIWidget)
	{
		...
		// TODO: AI 플레이어 정보 표시 (국가 이름, 플레이어 번호 등)
		// 필요시 AIPlayerLoseUI에 SetPlayerInfo() 같은 함수 추가
	}
}
