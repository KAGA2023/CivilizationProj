...
public:
    ...
    TObjectPtr<UTechComponent> TechComponent; // 기술 컴포넌트 참조
...
public:
    ...
    void SetTechComponent(UTechComponent* InTechComponent); // 기술 컴포넌트 설정

    UFUNCTION(BlueprintCallable, Category = "Tech Management")
    UTechComponent* GetTechComponent() const { return TechComponent; } // 기술 컴포넌트 반환
