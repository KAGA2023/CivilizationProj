...
void UCityComponent::UpdateAvailableProductions()
{
    ...
    for (const FName& RowName : BuildingRowNames)
    {
        ...
        // 플레이어 보유 기술 확인하여 필터링
        // TODO: SuperPlayerState->GetTechComponent()에서 연구 완료된 기술들의 UnlockedBuildings 확인
        // 현재는 모든 건물을 추가 (기술 시스템 연동 전)
        ...
        // 기술 조건 확인
        // TODO: SuperPlayerState->GetTechComponent()가 있고 연구 완료된 기술들의 UnlockedBuildings에 포함되어 있는지 확인
        ...
        //         {
        //             if (UTechComponent* TechComponent = PlayerState->GetTechComponent())
        //             {
        ...
        //                     if (TechData.UnlockedBuildings.Contains(RowName))
        //                     {
    ...
    {
        // 플레이어 보유 기술 확인하여 필터링
        // TODO: SuperPlayerState->GetTechComponent()에서 연구 완료된 기술들의 UnlockedUnits 확인
        // 현재는 모든 유닛을 추가 (기술 시스템 연동 전)
        ...
        // 기술 조건 확인
        // TODO: SuperPlayerState->GetTechComponent()가 있고 연구 완료된 기술들의 UnlockedUnits에 포함되어 있는지 확인
        // if (UWorld* World = GetWorld())
        // {
        //     if (USuperGameInstance* SuperGameInst = Cast<USuperGameInstance>(World->GetGameInstance()))
        //     {
        ...
        //                 {
        //                     FTechData TechData = TechComponent->GetTechDataFromTable(TechRowName);
        //                     if (TechData.UnlockedUnits.Contains(RowName))
        //                     {
