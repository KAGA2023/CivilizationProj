...
void UCityPurchaseSlotUI::NativeConstruct()
{
	...
	if (PurchaseBtn)
	{
		...
		PurchaseBtn->OnHovered.AddDynamic(this, &UCityPurchaseSlotUI::OnPurchaseBtnHovered);
		PurchaseBtn->OnUnhovered.AddDynamic(this, &UCityPurchaseSlotUI::OnPurchaseBtnUnhovered);
	}
}
...
void UCityPurchaseSlotUI::OnPurchaseBtnHovered()
{
	OnPurchaseSlotHovered.Broadcast(PurchaseID, bIsBuildingSlot);
}

void UCityPurchaseSlotUI::OnPurchaseBtnUnhovered()
{
	OnPurchaseSlotUnhovered.Broadcast();
}
