...
void UMainMenuUI::NativeConstruct()
{
	...
	if (CreditBtn)
	{
		CreditBtn->OnClicked.AddDynamic(this, &UMainMenuUI::OnCreditButtonClicked);
	}
	...
	// CreditUI 위젯 초기화 (Hidden으로 설정)
	if (CreditMenuUIWidget)
	{
		CreditMenuUIWidget->SetVisibility(ESlateVisibility::Hidden);
		// 델리게이트 바인딩
		BindCreditMenuUIDelegate();
	}
}
...
void UMainMenuUI::OnCreditButtonClicked()
{
	// CreditUI 위젯 표시
	if (CreditMenuUIWidget)
	{
		CreditMenuUIWidget->SetVisibility(ESlateVisibility::Visible);
	}
...
void UMainMenuUI::SetCreditMenuUI(UCreditUI* InCreditMenuUI)
{
	CreditMenuUIWidget = InCreditMenuUI;
...
void UMainMenuUI::BindCreditMenuUIDelegate()
{
	if (CreditMenuUIWidget)
	{
		// 기존 바인딩 제거 후 새로 바인딩
		CreditMenuUIWidget->OnBackButtonClickedDelegate.RemoveDynamic(this, &UMainMenuUI::ShowMainMenu);
		CreditMenuUIWidget->OnBackButtonClickedDelegate.AddDynamic(this, &UMainMenuUI::ShowMainMenu);
	}
}
