...
protected:
	...
	// 플레이어별 국경선 꼭짓점 구 컴포넌트 (국경선과 동일 머티리얼/색상) — TMap 값 제한으로 UPROPERTY 미사용, ParentActor 자식으로 소유됨
