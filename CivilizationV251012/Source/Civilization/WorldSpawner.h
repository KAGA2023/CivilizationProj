...
// 타일 스폰 진행률 델리게이트
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnTileSpawnProgress, int32, CurrentCount, int32, TotalCount);
...
public:	
	...
	FOnTileSpawnProgress OnTileSpawnProgress;
	...
	// WorldComponent 설정
	UFUNCTION(BlueprintCallable, Category = "World")
	void SetWorldComponent(UWorldComponent* NewWorldComponent);
