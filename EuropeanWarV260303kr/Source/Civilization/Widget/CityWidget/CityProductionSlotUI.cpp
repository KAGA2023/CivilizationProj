...
void UCityProductionSlotUI::NativeConstruct()
{
	...
	if (StartProductionBtn)
	{
		...
		StartProductionBtn->OnHovered.AddDynamic(this, &UCityProductionSlotUI::OnStartProductionBtnHovered);
		StartProductionBtn->OnUnhovered.AddDynamic(this, &UCityProductionSlotUI::OnStartProductionBtnUnhovered);
	}
}
...
void UCityProductionSlotUI::OnStartProductionBtnHovered()
{
	OnProductionSlotHovered.Broadcast(ProductionID, bIsBuildingSlot);
}

void UCityProductionSlotUI::OnStartProductionBtnUnhovered()
{
	OnProductionSlotUnhovered.Broadcast();
}
