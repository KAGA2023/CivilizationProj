...
void ASuperPlayerState::LoadCountryDataFromTable()
{
    ...
    CountrySmallImg = CountryData->CountrySmallImg;
    CountryRoundImg = CountryData->CountryRoundImg;
...
void ASuperPlayerState::CleanupDefeatedPlayer()
{
    ...
    if (CityComponent)
    {
        // TODO: 도시 파괴 애니메이션/이펙트 (나중에 추가 가능)
        // CityComponent->PlayDestroyAnimation();
