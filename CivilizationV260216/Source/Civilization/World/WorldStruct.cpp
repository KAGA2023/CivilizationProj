...
FString UWorldTile::GetClimateTypeName() const
{
    ...
    {
    case EClimateType::Temperate:    return TEXT("온대");
    case EClimateType::Desert:       return TEXT("사막");
    case EClimateType::Tundra:       return TEXT("설원");
...
FString UWorldTile::GetLandTypeName() const
{
    ...
    {
    case ELandType::Plains:          return TEXT("평지");
    case ELandType::Hills:           return TEXT("언덕");
    case ELandType::Mountains:       return TEXT("산");
    default:                         return TEXT("Unknown");
    }
}
...
FString UWorldTile::GetBonusResourceName() const
{
    ...
    case EBonusResource::Wheat:          return TEXT("밀");
    case EBonusResource::Corn:           return TEXT("옥수수");
    case EBonusResource::Chicken:        return TEXT("닭");
    case EBonusResource::Horse:          return TEXT("말");
    case EBonusResource::Deer:           return TEXT("사슴");
    case EBonusResource::Copper:         return TEXT("구리");
    default:                             return TEXT("Unknown");
    }
}
...
FString UWorldTile::GetStrategicResourceName() const
{
    ...
    case EStrategicResource::Iron:      return TEXT("철");
    default:                             return TEXT("Unknown");
    }
}
...
FString UWorldTile::GetLuxuryResourceName() const
{
    ...
    case ELuxuryResource::Tiger:         return TEXT("호랑이");
    case ELuxuryResource::Diamond:       return TEXT("다이아몬드");
    case ELuxuryResource::Golden:        return TEXT("황금");
    case ELuxuryResource::Silver:        return TEXT("은");
    case ELuxuryResource::Jade:           return TEXT("옥");
    case ELuxuryResource::Watermelon:    return TEXT("수박");
    case ELuxuryResource::Pumpkin:       return TEXT("호박");
    case ELuxuryResource::Sunflower:     return TEXT("해바라기");
    case ELuxuryResource::Tomato:        return TEXT("토마토");
    default:                             return TEXT("Unknown");
    }
}
